...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addToAllTCAtypes('fe_users', 'tx_rbtinyshop_domain_model_user_billingaddress, tx_rbtinyshop_domain_model_user_shippingaddress', '', 'after:usergroup');
