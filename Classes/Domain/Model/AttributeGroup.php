 ...
 * AttributeGroup
 */
class AttributeGroup extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
	/**
	 * title
	 *
	 * @var string
	 ...
	 * Removes a Attribute
	 *
	 * @param \RB\RbTinyshop\Domain\Model\Attribute $attributeToRemove The Attribute to be removed
	 * @return void
	 */
