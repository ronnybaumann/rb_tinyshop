<?php
namespace RB\RbTinyshop\Domain\Repository;
...
class ArticleRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	 ...
	 */
	public function findByCategory(\RB\RbTinyshop\Domain\Model\Category $category) {
		$query = $this->createQuery();
	
		$constraints = array();
	
		$constraints[] = $query->contains('categorys', $category);
