 ...
 * @api
 */
class ArticleNumberValidator extends \TYPO3\CMS\Extbase\Validation\Validator\AbstractValidator {
	 ...
	 *
	 * @var \RB\RbTinyshop\Domain\Repository\ArticleDetailRepository
	 * @inject
	 */
	...
	public function isValid($value) {
		...
		//$valueExist = $this->articleDetailRepository->findByArticleNumber($value);exit;
	}
}
